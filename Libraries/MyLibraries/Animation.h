...
namespace DX
{
    ...
    public:
        ...
        AnimationSDKMESH(const AnimationSDKMESH&) = delete;
        AnimationSDKMESH& operator= (const AnimationSDKMESH&) = delete;
    ...
    public:
        ...
        AnimationCMO(const AnimationCMO&) = delete;
        AnimationCMO& operator= (const AnimationCMO&) = delete;
